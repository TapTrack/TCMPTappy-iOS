...
import CoreBluetooth
 ...
 public class TappyBleDeviceDefinition{
    
        static public func getSerialServiceUuid() -> CBUUID{
            let SERVICE_TRUCONNECT_UUID: CBUUID = CBUUID(string: "175f8f23-a570-49bd-9627-815a6a27de2a")
            return SERVICE_TRUCONNECT_UUID
        }
    
        static public func getTxCharacteristicUuid()  -> CBUUID{
        ...
        static public func getRxCharacteristicUuid()  -> CBUUID{
    ...
    static public func isTappyDeviceName(device : CBPeripheral) -> Bool{
